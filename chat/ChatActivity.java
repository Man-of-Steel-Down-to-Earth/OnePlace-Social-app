package com.deeplab.oneplace.chat;
...
import com.deeplab.oneplace.GetTimeAgo;
import com.deeplab.oneplace.MainActivity;
import com.deeplab.oneplace.NightMode;
import com.deeplab.oneplace.R;
import com.deeplab.oneplace.Stickers;
import com.deeplab.oneplace.adapter.AdapterChat;
import com.deeplab.oneplace.calling.RingingActivity;
import com.deeplab.oneplace.faceFilters.FaceFilters;
import com.deeplab.oneplace.groupVoiceCall.RingingGroupVoiceActivity;
import com.deeplab.oneplace.meeting.MeetingActivity;
import com.deeplab.oneplace.model.ModelChat;
import com.deeplab.oneplace.model.ModelUser;
import com.deeplab.oneplace.notifications.Data;
import com.deeplab.oneplace.notifications.Sender;
import com.deeplab.oneplace.notifications.Token;
import com.deeplab.oneplace.profile.UserProfileActivity;
import com.deeplab.oneplace.calling.CallingActivity;
import com.deeplab.oneplace.watchParty.StartWatchPartyActivity;
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, response -> Timber.d("onResponse%s", response.toString()), error -> Timber.d("onResponse%s", error.toString())){
                            ...
                            public Map<String, String> getHeaders() {
                                ...
                                headers.put("Authorization", "key=AAAAsJhbLcU:APA91bFXqq9f3ZNa72MOii17fO40cCPpvm6FzXsgvcOCMCnrjEzDmThIgk1npqn4CWbcsxE5pdWqdtKhjG-Eyi7PvW3bffq2du40FSI5U48FyUVMqSReMDepQqv_yOdZ08zSeRMrBRki		");
                                return headers;
                            }
                        };
