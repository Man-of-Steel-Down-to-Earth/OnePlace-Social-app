package com.deeplab.oneplace.menu;
...
import com.deeplab.oneplace.marketPlace.MarketPlaceActivity;
import com.deeplab.oneplace.NightMode;
import com.deeplab.oneplace.R;
import com.deeplab.oneplace.admin.AdminActivity;
import com.deeplab.oneplace.faceFilters.FaceFilters;
import com.deeplab.oneplace.group.GroupFragment;
import com.deeplab.oneplace.live.StartLiveActivity;
import com.deeplab.oneplace.meeting.MeetingActivity;
import com.deeplab.oneplace.notifications.NotificationScreen;
import com.deeplab.oneplace.profile.EditProfileActivity;
import com.deeplab.oneplace.reel.ReelActivity;
import com.deeplab.oneplace.search.LocationActivity;
import com.deeplab.oneplace.search.SearchActivity;
import com.deeplab.oneplace.send.ImageEditingActivity;
import com.deeplab.oneplace.send.VideoEditingActivity;
import com.deeplab.oneplace.watchParty.StartWatchPartyActivity;
import com.deeplab.oneplace.welcome.IntroLast;
...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.invite).setOnClickListener(v -> {
            String shareBody = "oneplace - connect your friend" + " Download now on play store \nhttps://play.google.com/store/apps/details?id=com.deeplab.oneplace";
