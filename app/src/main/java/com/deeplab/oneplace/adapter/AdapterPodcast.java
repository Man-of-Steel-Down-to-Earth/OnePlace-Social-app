...
import com.deeplab.oneplace.model.ModelLive;
import com.deeplab.oneplace.podcast.PodcastActivity;
...
public class AdapterPodcast extends RecyclerView.Adapter<AdapterPodcast.MyHolder>{
    ...
    int channelProfile;
    public static final String channelMessage = "com.deeplab.oneplace.CHANNEL";
    public static final String profileMessage = "com.deeplab.oneplace.PROFILE";
