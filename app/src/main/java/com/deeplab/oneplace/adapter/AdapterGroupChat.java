...
import com.deeplab.oneplace.group.GroupChatActivity;
import com.deeplab.oneplace.meeting.MeetingActivity;
import com.deeplab.oneplace.model.ModelGroupChat;
import com.deeplab.oneplace.post.CommentActivity;
import com.deeplab.oneplace.profile.UserProfileActivity;
import com.deeplab.oneplace.reel.ViewReelActivity;
import com.deeplab.oneplace.search.SearchActivity;
import com.deeplab.oneplace.story.ChatStoryViewActivity;
import com.deeplab.oneplace.story.HighViewActivity;
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if (snapshot.exists()){
                        ...
                        MapboxStaticMap staticImage = MapboxStaticMap.builder()
                                .accessToken("sk.eyJ1IjoiZGVlcGFrMTEyMiIsImEiOiJjbDU0NTRiNjUwdnprM2RwcDN4aGp1eHF3In0.vYqywGJueD3BB4kLNrAHiw")
